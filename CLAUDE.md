...
│   ├─ adr/                ← ADR-0028부터 개별 파일 사용 시작. 분리 기준: 운영·인프라 및 대형 설계 ADR은 개별 파일(0028 인프라, 0029 cascade 시맨틱, 0030 baseline 테넌트 소유권, 0031 역할·권한 모델, 0032 평가 회차·워크플로, 0033 EUC·IUC 관리 모델, 0034 스코핑 모델), 코드 설계 ADR은 ClaudeICFR.md §10 요약 유지.
