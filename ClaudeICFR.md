...
| Scoping | ✅ ADR-0034 | ✅ | ✅ | ✅ 6-1 전역 템플릿(192계정)·회계연도 복사·필드 단위 템플릿 배지·중요성/양적/질적/결론 조회 시 산출·상태 전이·확정 스냅샷·질적 기준 정책 | ✅ 중요성·조정 항목·계정 평가(재무제표 탭)·수동 판정(사유 필수)·검토 기록·가이던스 + 대시보드 카드 | ✅ 29건 | 13.9-50. 마이그레이션 `a9b0c1d2e3f4` push 대기. 로컬 검증만. 6-2(GITC·프로세스 연결) 남음 |
