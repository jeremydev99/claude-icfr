...
4. **RCM baseline/overlay 후속 (ADR-0027)**: ~~2-A-1 병행 신규 구축~~ ✅ 완료 (2026-07-13). 다음: 2-A-2 기존 controls → baseline/instance 이관 → 2-A-3 조회 API 전환(resolve_controls 경유) → 2-A-4 CRUD 전환. 2-B에서 상위 계층(Process/Risk) baseline화 + baseline_risks FK 전환.
