...
11. **2-A-4-3 (부분 완료)** — 상위 3계층 조회·CRUD 전환은 **백엔드만** ✅ 완료(위 6번, `cad62a9`는 `backend/app/api/rcm.py`만 변경·프론트 0건). **남은 범위 둘**: upload-excel 파서 분리(10번), **상위 3계층 CRUD 프론트 배선(14번)**. 어서션 junction CRUD(9번)는 2026-09-01 완료. 남은 xfail 1건은 10번에 붙어 있다(6건 중 4건은 6번, 1건은 9번 작업으로 해소).
