...
# **회계연도가 시작하는 달** (1~12, 기본 1). 결산월이 아니라 시작월이다.
#   12월 결산 회사 → 1  (회계연도 1/1~12/31. 한국 상장사 대부분)
#   3월 결산 회사  → 4  (회계연도 4/1~3/31. 1분기가 4/1~6/30)
# 의미가 흔들리면 Report 모듈까지 비용이 번지므로 예시를 함께 남긴다.
