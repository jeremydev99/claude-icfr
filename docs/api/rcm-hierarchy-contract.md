...
>
> 참조 표기 — 문서명 없는 `§5` 는 이 문서의 절이다. 다른 문서는 `ADR-0029 §3`,
> `ClaudeICFR.md` 13.9-18 처럼 문서명을 붙인다.
...
`_assert_code_available` 은 상위 3계층 resolver 배선 작업(`cad62a9`)에서 신설되며 상위 3계층에만 적용되고
